...
> 读本文件前先看完这三节。
> **本文件的读法**：§0.1–§0.43 是一格一段的增量（§0.43 最新，`04259ef`/`6f0bc6e`/`8456199`），§1 起手命令与现在值，
...
最近一轮实测基线（到 `8456199`）：**1409 单测 / 189 套件 / 0 失败 / 0 错误 / 0 跳过**；
往上依次是 `1f980d4` 1399/188、`d0b6358` 1388/187、`16e4bd6` 1384/186。
（+10 = `FeedbackCasesSemanticsTest` 新套件八格 + `PageHeaderConsistencyTest` 第五页 +
