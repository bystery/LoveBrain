...
最近一轮实测基线（到 `1f980d4`）：**1399 单测 / 188 套件 / 0 失败 / 0 错误 / 0 跳过**；
往上依次是 `d0b6358` 1388/187、`16e4bd6` 1384/186、`856d485` 1382/186。
（+11 = `SourceScanTest` 十格（尺自己的正向/反向对照）+
`UiLayerDependencyContractTest` 那一格新闸，账本 §55。）
