...
| 测试套件 | 测试类数 | 说明 |
|---|---|---|
| 数据层 | 7 | DeepSeek API 错误映射、EventBus 捕获、知识库安全/重入/备份、向量标签契约 |
| 领域层 | 5 | 知识引擎契约、消息截断、Prompt 组装顺序/阶段契约 |
| ViewModel | 4 | 花费展示、草稿持久化、想法提示、R2 回归 |
| UI/工具 | 2 | 对比度回归、JSON 工具 |
| **合计** | **18** | 运行命令：`./gradlew test` |
